# Name- Rishika Bhambri, Date-11/11/25 ,Title- Daily Calorie Tracker CLI
print("==================================================")
print("      Welcome to the Daily Calorie Tracker!       ")
print("==================================================")
print("Welcome, This is a Python-Based tool for quick and simple way to monitor your daily calorie intake.")

def permission(question_prompt):
    while True:
...
if permission("Do you want to see the average calories per meal?"):
...
if permission("Do you want to set your own daily calorie limit?"):
...
if permission("Do you want to save todays report"):
    print("Proceeding...")
